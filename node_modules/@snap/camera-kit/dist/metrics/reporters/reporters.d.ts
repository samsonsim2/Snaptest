...
export declare const reportSessionScopedMetrics: PartialContainer<{
    ...
    sessionState: import("@snap/state-management").StateMachine<import("@snap/state-management").Action<"suspend", import("../../session/CameraKitSession").CameraKitSession> | import("@snap/state-management").Action<"resume", import("../../session/CameraKitSession").CameraKitSession> | import("@snap/state-management").Action<"destroy", undefined>, import("@snap/state-management").State<"inactive", undefined> | import("@snap/state-management").State<"active", import("../../session/CameraKitSession").CameraKitSession> | import("@snap/state-management").State<"destroyed", undefined>>;
    CameraKitSession: import("../../session/CameraKitSession").CameraKitSession;
